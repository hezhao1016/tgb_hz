...
public class Lunar {
	...
	private static final long[] lunarInfo = new long[] { 0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0,
	...
	/**
	 * 返回y年m月d日对应的农历
	 * <b/>yearCyl3:农历年与1864的相差数　　
	 * <b/>monCyl4:从1900年1月31日以来,闰月数
	 * <b/>dayCyl5:与1900年1月31日相差的天数,再加40
	 * @param cal
	 */
	...
	public String getChinaYearString(){
		String[] years = {"零","一","二","三","四","五","六","七","八","九"};
	...
	public String toString() {
		return getChinaYearString() + "年" + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + getChinaDayString(day);
	}

	public static void main(String[] args) throws ParseException {
		Calendar today = Calendar.getInstance();
		today.setTime(Lunar.chineseDateFormat.parse("2016年2月4日"));
		Lunar lunar = new Lunar(today);
		System.out.println("北京时间：" + Lunar.chineseDateFormat.format(today.getTime()) + "\n农历：" + lunar);
	}
}
