 ...
 * CharacterEncoder and CharacterDecoder classes, one complete chunk of data is referred to as a <i>buffer</i>. Encoded buffers are all text, and decoded buffers (sometimes just referred to as
