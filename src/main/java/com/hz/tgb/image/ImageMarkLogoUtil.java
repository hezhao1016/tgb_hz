...
public class ImageMarkLogoUtil {
    ...
    /** 水印纵向位置 */
	private static int positionHeight = 600;
	/** 水印文字字体 */
	...
	public static void main(String [] args){
		String srcImgPath = "d:/test/pic.jpg";  
		String logoText = "[ I love You]";
		String iconPath = "d:/test/jxl.png";  
		
		String targerTextPath = "d:/test/pic1.jpg";  
		String targerTextPath2 = "d:/test/pic2.jpg";
		
		String targerIconPath = "d:/test/pic3.jpg";  
		String targerIconPath2 = "d:/test/pic4.jpg";
		...
		setImageMarkOptions(0.8f,50,50,null,null);
		// 给图片添加水印图片  
