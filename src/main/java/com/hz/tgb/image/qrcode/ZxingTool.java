package com.hz.tgb.image.qrcode;
...
import com.hz.tgb.file.DirFileListUtil;
...
//        String barcode = new ZxingTool().decodeBarcode("D:\\Program Files (x86)\\Default Company Name\\PictureToolSetUp\\GroupImage\\BXN1904280001351\\32.png");
//        System.out.println(barcode);


        List<String> list = DirFileListUtil.getList("C:\\Users\\hezhao\\Documents\\Scanned Documents\\barcode");
        for (String filePath : list) {
            System.out.println("开始识别> " + filePath);
            String barcode2 = new ZxingTool().decodeBarcode(filePath);
